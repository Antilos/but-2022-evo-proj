...
\projectinfo{
  ...
  title={Optimalizácia farbenia grafu genetickým algoritmom}, % Název prezentace / Presentation title (The whole title of the presented work suitably divided into lines that are optically balanced)
  ...
  author.surname={Kočalka}, % Příjmení autora / Author surname
